export function welcomeEmail(input: { firstName: string }) {
  ...
  <p style="margin-top:24px"><a href="https://keralaayurvedic.my/account/dashboard" style="display:inline-block;background:#2F5D50;color:#fff;padding:12px 22px;border-radius:999px;text-decoration:none;font-weight:700">Open your dashboard</a></p>
