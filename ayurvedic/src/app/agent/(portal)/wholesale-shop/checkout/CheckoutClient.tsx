    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_360px]">
      ...
      <div className="flex flex-col gap-4">
          ...
          <ul className="mt-3 divide-y divide-[#1e3d32]/6">
            {lines.map((l) => (
              <li key={l.productId} className="flex items-center gap-3 py-3">
                <div className="h-14 w-14 shrink-0 overflow-hidden rounded-lg bg-[#FAF6EE]/40">
                  {l.product.imageUrl ? (
                ...
                <div className="flex-1">
                  <p className="text-[13px] font-semibold text-[#1e3d32]">
                    {l.product.name}
                  </p>
        ...
        <section className="rounded-3xl border border-[#1e3d32]/10 bg-white p-5">
          ...
          <p className="mt-0.5 text-[11.5px] text-[#2B2B2B]/55">
