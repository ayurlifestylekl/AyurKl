...
export default async function AssessmentsHubPage() {
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6 sm:gap-8">
      {/* ── HERO ──────────────────────────────────────────────────── */}
      <header className="relative overflow-hidden rounded-3xl border border-[#6E1023]/8 bg-white px-6 py-8 sm:px-10 sm:py-12">
        <div
          aria-hidden
        ...
        <div className="relative">
          ...
          <h1
            className="mt-3 font-heading text-[32px] font-bold leading-tight text-[#6E1023] sm:text-[44px]"
