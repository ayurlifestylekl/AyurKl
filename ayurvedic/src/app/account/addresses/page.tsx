    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-6 sm:gap-7">
      <header>
        <span className="inline-flex items-center gap-2 font-heading text-[11px] font-semibold uppercase tracking-[0.22em] text-[#163F33]/55">
          <MapPin className="h-3.5 w-3.5 text-[#D4AF37]" strokeWidth={2} />
          Saved addresses
        </span>
        <h1
        ...
        <p className="mt-3 max-w-xl font-body text-[14px] text-[#1F1F1F]/65" style={{ lineHeight: 1.65 }}>
      ...
      <section>
        ...
        {addresses.length > 0 ? (
          ...
          <p className="rounded-3xl border border-dashed border-[#163F33]/15 bg-white px-5 py-6 text-center font-body text-[13px] italic text-[#1F1F1F]/55">
