...
export default function ReplyForm({ ticketId }: { ticketId: string }) {
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl border border-[#1e3d32]/8 bg-white p-4">
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-[#2F5D50] px-4 py-2 text-[13px] font-semibold text-white hover:bg-[#1e3d32] disabled:opacity-50"
        >
