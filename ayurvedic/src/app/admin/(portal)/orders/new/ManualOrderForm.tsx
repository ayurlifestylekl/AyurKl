  ...
  return (
    <form onSubmit={submit} className="mt-4 flex flex-col gap-4">
      ...
      <fieldset className="rounded-2xl border border-[#6E1023]/8 bg-white p-4">
        ...
        {items.length > 0 ? (
          <ul className="mt-2 divide-y divide-[#6E1023]/6">
            {items.map((it, i) => {
              const p = products.find((p) => p.id === it.productId)
              return (
                <li key={i} className="flex items-center gap-2 py-2 text-[13px]">
                  ...
                  <input
                    ...
                    className="w-16 rounded border border-[#6E1023]/15 px-2 py-1 text-right"
                  />
        ...
        <p className="mt-2 border-t border-[#6E1023]/6 pt-2 text-right font-semibold text-[#6E1023]">
