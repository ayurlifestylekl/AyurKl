  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-[#6E1023]/10 bg-white p-3">
      <input
        ...
        className="min-w-[200px] flex-1 rounded-lg border border-[#6E1023]/10 bg-white px-3 py-1.5 text-sm placeholder:text-[#1F1F1F]/40 focus:border-[#6E1023] focus:outline-none"
      />
      <select
        value={sp.get('status') ?? ''}
