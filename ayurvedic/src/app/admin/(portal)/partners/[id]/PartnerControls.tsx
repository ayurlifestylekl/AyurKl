    ...
    <div className="flex flex-col gap-4">
      ...
      <article className="rounded-2xl border border-[#1e3d32]/8 bg-white p-4">
        ...
        <button
          ...
          onClick={saveRate}
          className="mt-3 rounded-lg bg-[#2F5D50] px-3 py-1.5 text-[12px] font-semibold text-white hover:bg-[#1e3d32] disabled:opacity-50"
        >
      ...
      <article className="rounded-2xl border border-[#1e3d32]/8 bg-white p-4">
        ...
        <div className="mt-3 flex flex-col gap-2">
          <label className="flex cursor-pointer items-start gap-2 rounded-lg border border-[#1e3d32]/8 px-3 py-2">
            <input
              type="checkbox"
