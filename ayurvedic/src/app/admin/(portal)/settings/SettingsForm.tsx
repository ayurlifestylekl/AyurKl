    ...
    >
      ...
      <Card title="Booking" subtitle="Rules for consultation appointments.">
        <Grid>
          ...
          />
          <label className="col-span-2 flex cursor-pointer items-center gap-2 rounded-lg border border-[#6E1023]/10 bg-white px-3 py-2.5">
            <input
              type="checkbox"
            ...
            <span className="text-[13px]">
              ...
              <span className="ml-2 text-[11.5px] text-[#1F1F1F]/55">
      ...
      {/* Save bar */}
      <div className="sticky bottom-4 z-10 flex items-center justify-between gap-3 rounded-2xl border border-[#6E1023]/10 bg-white/95 p-3 shadow-lg shadow-black/5 backdrop-blur">
        ...
        <button
          type="submit"
          disabled={pending}
          className="rounded-lg bg-[#6E1023] px-4 py-2 text-[12.5px] font-semibold text-white hover:bg-[#6E1023] disabled:opacity-50"
        >
  ...
  return (
    <section className="rounded-2xl border border-[#6E1023]/10 bg-white p-5">
      <header className="mb-4">
        <h2 className="font-heading text-[15px] font-semibold text-[#6E1023]">{title}</h2>
        {subtitle ? (
          <p className="mt-0.5 text-[12px] text-[#1F1F1F]/60">{subtitle}</p>
        ) : null}
      </header>
      {children}
    </section>
  ...
  return (
    <label className={`flex flex-col gap-1 ${full ? 'sm:col-span-2' : ''}`}>
      ...
      <input
        ...
        className="rounded-lg border border-[#6E1023]/15 bg-white px-3 py-2 text-[13px] focus:border-[#6E1023] focus:outline-none"
      />
    </label>
  )
}
