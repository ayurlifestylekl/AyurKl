          ...
          {columns.map((col) => (
            <div key={col.code} className="flex-1 border-l border-accent/15" style={{ minWidth: COL_W }}>
              <div
                ...
                className="sticky top-16 z-10 flex items-center justify-center border-b border-accent/20 px-2 text-center font-heading text-[11px] font-bold uppercase tracking-[0.1em] bg-cream/60 text-primary"
              >
                {col.name}
              </div>
              <div
