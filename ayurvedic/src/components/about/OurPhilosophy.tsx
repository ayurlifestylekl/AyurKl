...
/**
 * Philosophy — horizontal rule list with gold hairline separators.
 * No oversized numerals, no gradient icon circles.
 */
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-14 sm:px-8 md:py-20 lg:px-12">
        ...
        >
          ...
          >
            Holistic wellness that treats body, mind, and spirit as a whole.
          </h2>
        </motion.div>
        ...
        >
          {philosophyPillars.map((pillar, i) => {
            ...
            return (
              <motion.div key={pillar.id} variants={fadeUp(0)} className="group">
                {/* Gold hairline */}
                <div
                  className="h-px"
                  style={{
