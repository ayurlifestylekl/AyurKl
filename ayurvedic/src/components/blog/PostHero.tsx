  ...
  return (
    <header className="relative overflow-hidden bg-[#F7F2E8]">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 8% 10%, rgba(212, 175, 55,0.16) 0%, transparent 55%), radial-gradient(ellipse at 92% 0%, rgba(110,16,35,0.10) 0%, transparent 50%)',
        }}
      />
      <div
        aria-hidden
      ...
      {post.heroImageUrl && (
        ...
        >
          <div className="relative aspect-[16/9] overflow-hidden rounded-[28px] shadow-[0_2px_4px_rgba(110,16,35,0.06),0_40px_100px_-30px_rgba(110,16,35,0.32)] ring-1 ring-primary/10">
            <Image
