...
export default function OrderActions({
  ...
  return (
    ...
    >
      <div className="border-b border-[#1e3d32]/6 px-5 py-3 sm:px-6">
      ...
      <div className="grid grid-cols-1 gap-2.5 px-5 py-4 sm:grid-cols-2 sm:gap-3 sm:px-6 lg:grid-cols-4">
        ...
        {canReorder ? (
          ...
          <button
            type="button"
            disabled
            className="inline-flex h-11 items-center justify-center gap-2 rounded-full border border-[#1e3d32]/12 bg-[#FAF6EE]/40 px-4 font-heading text-[12px] font-semibold text-[#1e3d32]/45"
          >
            Reorder
          </button>
        )}
        ...
        {canReceipt ? (
          <a
            ...
            download
            className="group inline-flex h-11 items-center justify-center gap-2 rounded-full border border-[#1e3d32]/15 bg-white px-4 font-heading text-[12px] font-bold uppercase tracking-[0.14em] text-[#1e3d32] transition-all hover:border-[#1e3d32]/35 hover:bg-[#1e3d32]/[0.03] active:scale-[0.98]"
          >
        ...
        <a
          ...
          className="group inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#2F5D50] px-4 font-heading text-[12px] font-bold uppercase tracking-[0.14em] text-white transition-all hover:bg-[#264a40] active:scale-[0.98]"
        >
      ...
      <p className="border-t border-[#1e3d32]/6 px-5 py-3 font-body text-[11px] italic text-[#2B2B2B]/55 sm:px-6">
