...
const STATUS_LABEL: Record<PaymentStatus, { label: string; tone: string }> = {
  paid:     { label: 'Paid',     tone: 'text-[#6E1023] bg-[#6E1023]/[0.08] border-[#6E1023]/25' },
    ...
    >
      <div className="flex items-center gap-2.5 border-b border-[#6E1023]/6 px-5 py-3 sm:px-6">
        <span className="flex h-7 w-7 items-center justify-center rounded-xl bg-[#6E1023]/[0.06]">
          <CreditCard className="h-3.5 w-3.5 text-[#6E1023]" strokeWidth={1.8} />
        </span>
      ...
      <div className="space-y-3 px-5 py-4 sm:px-6">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-[#6E1023]/6 pt-3">
          ...
          <span className="font-heading text-[13px] font-semibold text-[#6E1023]">
            Billplz
          </span>
        </div>
        ...
        <div className="flex items-center justify-between gap-3 border-t border-[#6E1023]/6 pt-3">
          ...
          <span
            className="font-heading text-[16px] font-bold text-[#6E1023]"
