...
export default function VaidyaNote() {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-[#163F33]/8 bg-gradient-to-br from-[#F7F2E8] via-white to-[#F7F2E8]/50 px-6 py-10 text-center sm:px-12 sm:py-14">
      {/* Decorative top rule */}
      ...
      <blockquote
        className="mx-auto max-w-2xl font-display italic text-[#163F33] sm:text-[22px]"
