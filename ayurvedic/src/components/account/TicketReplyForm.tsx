    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 px-5 py-4 sm:px-6 sm:py-5">
        ...
        <textarea
          ...
          className="resize-y rounded-2xl border border-[#1e3d32]/15 bg-white px-4 py-3 font-body text-[13.5px] text-[#1e3d32] placeholder:text-[#2B2B2B]/40 focus:border-[#D4A373] focus:outline-none focus:ring-2 focus:ring-[#D4A373]/30 disabled:cursor-not-allowed disabled:bg-[#1e3d32]/[0.03] disabled:opacity-60"
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-1.5 font-heading text-[11px] font-semibold uppercase tracking-[0.16em] text-[#1e3d32]/55 transition-colors hover:text-[#D4A373]"
            ...
            {!isResolved && !isClosed && (
              <button
                ...
                className="inline-flex items-center gap-1.5 font-heading text-[11px] font-semibold uppercase tracking-[0.16em] text-[#1e3d32]/55 transition-colors hover:text-[#2F5D50] disabled:opacity-50"
              >
