  ...
  return (
    <div className="flex items-start gap-4 px-5 py-4 sm:px-6">
      ...
      <div className="flex h-14 w-14 shrink-0 flex-col items-center justify-center rounded-2xl bg-[#D4AF37]/12">
        ...
        <span
          className="font-heading text-[20px] font-bold leading-none text-[#6E1023]"
      ...
      <div className="flex-1 min-w-0">
        <h3
          className="font-heading text-[14.5px] font-semibold text-[#6E1023]"
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3 font-body text-[11.5px] text-[#6E1023]/60">
          <span className="inline-flex items-center gap-1">
            <Clock className="h-3 w-3" />
            {time} · {duration} min
          </span>
          {appointment.mode === 'virtual' ? (
            <span className="inline-flex items-center gap-1 text-[#6E1023]/85">
          ...
          {advance != null && Number(advance) > 0 && (
            <span className="inline-flex items-center gap-1 rounded-full border border-[#6E1023]/25 bg-[#6E1023]/8 px-2 py-0.5 font-heading text-[10px] font-semibold uppercase tracking-[0.08em] text-[#6E1023]">
      ...
      <Calendar className="mt-1 h-3.5 w-3.5 shrink-0 text-[#6E1023]/25" strokeWidth={1.8} />
    </div>
  )
}
