  ...
  if (!open) {
    return (
      <button
        ...
        className="group inline-flex h-12 w-full items-center justify-between gap-3 rounded-3xl border border-dashed border-[#6E1023]/15 bg-white px-5 transition-all hover:border-[#D4AF37]/45 hover:bg-[#F7F2E8]/35 sm:px-6"
      >
        <span className="inline-flex items-center gap-2.5">
          ...
          <span className="font-heading text-[12.5px] font-semibold text-[#6E1023]">
            Start a new conversation
          </span>
        </span>
        <span className="font-heading text-[10.5px] font-semibold uppercase tracking-[0.16em] text-[#6E1023]/55 group-hover:text-[#D4AF37]">
          New message
        </span>
      </button>
    )
    ...
    >
      <div className="flex items-center gap-2.5 border-b border-[#6E1023]/6 px-5 py-3 sm:px-6">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-1 font-heading text-[10.5px] font-semibold uppercase tracking-[0.16em] text-[#6E1023]/55 transition-colors hover:text-red-700"
        >
          <X className="h-3 w-3" />
          Cancel
        </button>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 px-5 py-5 sm:px-6">
        {/* Topic */}
        <div>
          <label htmlFor="new-ticket-topic" className="block font-heading text-[10.5px] font-semibold uppercase tracking-[0.18em] text-[#6E1023]/55">
            Topic
          </label>
