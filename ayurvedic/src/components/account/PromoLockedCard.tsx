...
export default function PromoLockedCard({
  ...
  return (
    <div
      className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#6E1023]/6 bg-[#F7F2E8]/30 p-5 opacity-80"
      style={{
        boxShadow:
    ...
    >
      <div className="flex items-start justify-between">
        <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-white">
          <Icon className="h-4 w-4 text-[#6E1023]/45" strokeWidth={1.8} />
        </span>
      ...
      <div className="mt-4 flex-1">
        <h3
          className="font-heading text-[14px] font-bold text-[#6E1023]/85"
