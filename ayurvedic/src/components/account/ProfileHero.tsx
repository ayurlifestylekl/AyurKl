...
export default function ProfileHero({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-[#FAF6EE]/55 to-transparent"
      />
      ...
      <div className="relative flex flex-wrap items-center gap-5 px-5 py-7 sm:px-9 sm:py-9">
        ...
        <div className="flex-1 min-w-0">
          <span className="inline-flex items-center gap-2 font-heading text-[10.5px] font-semibold uppercase tracking-[0.22em] text-[#1e3d32]/55">
          ...
          {archetype ? (
            <Link
              ...
              className="group mt-3 inline-flex items-center gap-1.5 rounded-full border border-[#D4A373]/30 bg-[#FAF6EE]/55 px-3 py-1 font-heading text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1e3d32] transition-all hover:border-[#D4A373]/55 hover:bg-[#FAF6EE]"
            >
              <span
                className="italic text-[#D4A373]"
                style={{ fontFamily: 'var(--font-playfair)' }}
              >
                {archetype.sanskrit}
              </span>
              <span className="text-[#1e3d32]/50">·</span>
            ...
            <Link
              ...
              className="group mt-3 inline-flex items-center gap-1.5 font-heading text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1e3d32]/55 underline-offset-4 transition-colors hover:text-[#D4A373] hover:underline"
            >
