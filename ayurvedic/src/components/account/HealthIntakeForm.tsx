...
export default function HealthIntakeForm({ initial }: HealthIntakeFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      {/* PDPA banner */}
      <div className="flex items-start gap-3 rounded-2xl border border-[#D4A373]/25 bg-[#FAF6EE]/55 px-4 py-3.5">
        <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-[#D4A373]/15">
          <ShieldCheck className="h-3.5 w-3.5 text-[#D4A373]" strokeWidth={2} />
        </span>
        <div>
          <p className="font-heading text-[12px] font-semibold text-[#1e3d32]">
            Vaidya uses this to keep you safe.
          </p>
          <p className="mt-0.5 font-body text-[11.5px] text-[#2B2B2B]/65" style={{ lineHeight: 1.55 }}>
