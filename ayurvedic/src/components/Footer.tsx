...
export default function Footer() {
  return (
    <footer className="bg-[#350710] text-white">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-x-10">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-3">
            ...
            <div className="mt-5 flex items-center gap-4">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/KeralaAyurvedicLifestyle"
                target="_blank"
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@keralaayurvediclifestyle"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="text-white/50 transition-colors hover:text-accent"
        ...
        <div className="mt-12 border-t border-white/10 pt-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="font-body text-xs text-white/30">
              <p className="font-semibold text-white/50">Ayurvedic Lifestyle (KL) Sdn Bhd</p>
              <p>Reg. No: 847466D · Brickfields, Kuala Lumpur, Malaysia</p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <span className="font-body text-xs text-white/20">
                © {new Date().getFullYear()} Kerala Ayurvedic Lifestyle Sdn Bhd
              </span>
            </div>
          </div>
        </div>
