...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    text: 'I had been struggling with chronic back pain for years. After just three Abhyanga sessions with Vaidya Akhil H.S., B.A.M.S., M.D. (Ayu), the relief was incredible. The therapists are so skilled — you can tell they have real Kerala training.',
    treatment: 'Abhyanga',
    date: 'February 2026',
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    text: 'I did the full Panchakarma detox programme over five days. The personalised dosha assessment from Vaidya Akhil H.S., B.A.M.S., M.D. (Ayu) was very thorough. I felt lighter, clearer, and more energised than I have in years.',
  ...
  },
  {
    ...
    location: 'Cheras, KL',
    rating: 5,
    text: 'I brought my mother here for elderly wellness care. The team was so gentle and attentive. Vaidya Akhil H.S., B.A.M.S., M.D. (Ayu) took time to explain every step of the treatment plan. We have been coming back every month since.',
