...
export const faqs: FAQ[] = [
  {
    id: 'what-is-ayurveda',
    question: 'What exactly is Kerala Ayurveda — and how is it different?',
    answer:
      'Kerala Ayurveda is the southern, ocean-influenced lineage of Ayurveda known for its emphasis on classical Panchakarma, oil-based therapies and personalised herbal protocols. Every treatment we offer is rooted in this 5,000-year-old tradition and adapted for modern bodies dealing with stress, inactivity and processed food.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Always. Kerala Ayurveda is strictly same-gender — male therapists work with male guests and female therapists with female guests. This is non-negotiable and is part of how we keep the practice respectful, safe and authentic.',
  },
  {
    id: 'cancellation',
  ...
  },
  {
    ...
    answer:
      'Every product in our apothecary is hand-blended in small batches using herbs and oils sourced directly from trusted Kerala suppliers. There are no fillers, parabens or synthetic fragrances — what you see on the label is what is in the bottle.',
  },
  {
    id: 'shipping-payment',
  ...
  {
    id: 'clinic-location',
    question: 'Where is Kerala Ayurvedic Lifestyle located?',
    answer:
      'Kerala Ayurvedic Lifestyle is located in Brickfields, Kuala Lumpur — the cultural heart of KL. We have been serving the Klang Valley community with authentic Kerala Ayurveda treatments since 2008. Walk-ins are welcome, but we recommend booking a consultation in advance via WhatsApp.',
  },
]
